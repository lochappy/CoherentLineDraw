...
#define MKTYPE2_I(NAME) pycld##_##NAME##_specials(); if (!to_ok(&pycld##_##NAME##_Type)) return NULL;
#else
#define MKTYPE2(NAME) MKTYPE2_I(NAME)
#define MKTYPE2_I(NAME) pycld##_##NAME##_specials(); if (!to_ok(&pycld##_##NAME##_Type)) return
#endif
...
#include QUOTEME(build/pycld_generated_include.h)
...
#define PYOPENCV_TO  pycld_to
#define PYOPENCV_FROM  pycld_from
...
#include QUOTEME(build/pycld_generated_types.h)

#include QUOTEME(build/pycld_generated_funcs.h)
...
#include QUOTEME(build/pycld_generated_ns_reg.h)
...
#include QUOTEME(build/pycld_generated_type_reg.h)
...
#include QUOTEME(build/pycld_generated_type_publish.h)
